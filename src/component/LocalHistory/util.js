...
export function getLocalDocuments(db, DocumentID) {
  try {
...
export function setLocalDocuments(db, localDocuments, document = {}) {
  const draftIndex = 0
...
export function setLocalDraft(db, localDocuments, document = {}) {
